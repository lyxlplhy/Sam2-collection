...
def main():
    ...
    parser.add_argument(
        "--sam2_cfg",
        type=str,
        default="D:\sam2\segment-anything-2-main\sam2_configs\sam2.1_hiera_t.yaml",
        help="SAM 2 model configuration file",
    )
    parser.add_argument(
        "--sam2_checkpoint",
        type=str,
        default="D:\sam2\segment-anything-2-main\checkpoints\sam2.1_hiera_tiny.pt",
    ...
    parser.add_argument(
        "--yolo_checkpoint",
        type=str,
        default=r"D:\sam2\ultralytics-main\ultralytics-main\runs\detect\train39\weights\best.pt",
        help="yolo目标检测的权重文件",
    )
    parser.add_argument(
        "--input_dir",
        default=r"E:\LYX_date\cover_date\data",
        help="输入照片路径",
    )
    parser.add_argument(
        "--output_dir",
        default=r"E:\LYX_date\cover_date\data_out",
        help="输出结果文件路径",
    )
    parser.add_argument(
        "--is_save_mask",
    ...
    parser.add_argument(
        "--save_mask_file",
        default=r"E:\LYX_date\white_yudoufu\1mask",
        help=r"保存mask的地址",
    )
